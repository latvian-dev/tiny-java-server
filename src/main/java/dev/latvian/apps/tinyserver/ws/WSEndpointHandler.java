...
public record WSEndpointHandler<REQ extends HTTPRequest, WSS extends WSSession<REQ>>(HTTPServer<REQ> server, WSSessionFactory<REQ, WSS> factory, Map<UUID, WSS> sessions) implements WSHandler<REQ, WSS>, HTTPHandler<REQ> {
